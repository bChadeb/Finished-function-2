...
const waddleDee = (para1, para2) => console.log(`The first parameter is ${para1}. The second parameter is ${para2}`)


// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.
waddleDee("deez mandarin oranges", "in yo mouth")
...
greeting("BillyBob", "Joe", (fullName) => {
